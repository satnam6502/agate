...
d_sequence_12 ::
  ...
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny MAlonzo.Code.IO.Base.T_IO_20 ->
...
du_sequence_12 v0 v1
  = case coe v1 of
      MAlonzo.Code.Codata.Musical.Colist.Base.C_'91''93'_24
        -> coe MAlonzo.Code.IO.Base.C_pure_30 (coe v1)
      MAlonzo.Code.Codata.Musical.Colist.Base.C__'8759'__30 v2 v3
        -> coe
             MAlonzo.Code.IO.Base.C_bind_40 (coe du_'9839''45'0_327 (coe v2))
             (coe du_'9839''45'1_509 (coe v0) (coe v3))
...
du_sequence'8242'_22 v0 v1
  = case coe v1 of
      ...
      MAlonzo.Code.Codata.Musical.Colist.Base.C__'8759'__30 v2 v3
        -> coe
             MAlonzo.Code.IO.Base.C_seq_48 (coe du_'9839''45'5_2639 (coe v2))
             (coe du_'9839''45'6_2819 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
-- IO.Colist.mapM
d_mapM_28 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
...
d_sequence_42 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  () ->
  [MAlonzo.Code.IO.Base.T_IO_20] -> MAlonzo.Code.IO.Base.T_IO_20
d_sequence_42 ~v0 ~v1 v2 = du_sequence_42 v2
du_sequence_42 ::
  [MAlonzo.Code.IO.Base.T_IO_20] -> MAlonzo.Code.IO.Base.T_IO_20
du_sequence_42 v0
  = case coe v0 of
      [] -> coe MAlonzo.Code.IO.Base.C_pure_30 (coe v0)
      (:) v1 v2
        -> coe
             MAlonzo.Code.IO.Base.du__'60''42''62'__82
             (coe
                MAlonzo.Code.IO.Base.du__'60''42''62'__82
                (coe
                   MAlonzo.Code.IO.Base.C_pure_30
...
du_sequence'8242'_48 v0
  = case coe v0 of
      ...
      (:) v1 v2
        -> coe
             MAlonzo.Code.IO.Base.du__'62''62'__114 (coe v1)
...
d_'9839''45'0_327 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny MAlonzo.Code.IO.Base.T_IO_20) ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'0_327 ~v0 ~v1 v2 ~v3 = du_'9839''45'0_327 v2
du_'9839''45'0_327 ::
  MAlonzo.Code.IO.Base.T_IO_20 ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
du_'9839''45'0_327 v0
...
d_'9839''45'1_509 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'1_509 v0 ~v1 ~v2 v3 v4 = du_'9839''45'1_509 v0 v3 v4
du_'9839''45'1_509 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity
    AgdaAny
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
du_'9839''45'1_509 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         MAlonzo.Code.IO.Base.C_bind_40
         (coe du_'9839''45'2_727 (coe v0) (coe v1))
         (coe du_'9839''45'3_1105 (coe v2)))
-- IO.Colist._._.♯-2
d_'9839''45'2_727 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  () ->
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'2_727 v0 ~v1 ~v2 v3 ~v4 = du_'9839''45'2_727 v0 v3
du_'9839''45'2_727 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity
    AgdaAny
...
d_'9839''45'3_1105 ::
  ...
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'3_1105 ~v0 ~v1 ~v2 ~v3 v4 v5
  = du_'9839''45'3_1105 v4 v5
du_'9839''45'3_1105 ::
  AgdaAny ->
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
du_'9839''45'3_1105 v0 v1
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         MAlonzo.Code.IO.Base.C_pure_30
...
d_'9839''45'4_1439 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny AgdaAny)
d_'9839''45'4_1439 ~v0 ~v1 ~v2 ~v3 ~v4 v5 = du_'9839''45'4_1439 v5
du_'9839''45'4_1439 ::
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity
...
d_'9839''45'5_2639 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny MAlonzo.Code.IO.Base.T_IO_20) ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'5_2639 ~v0 ~v1 v2 ~v3 = du_'9839''45'5_2639 v2
du_'9839''45'5_2639 ::
  MAlonzo.Code.IO.Base.T_IO_20 ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
du_'9839''45'5_2639 v0
  = coe MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16 (coe v0)
-- IO.Colist._.♯-6
d_'9839''45'6_2819 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny MAlonzo.Code.IO.Base.T_IO_20) ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_20
d_'9839''45'6_2819 v0 ~v1 ~v2 v3 = du_'9839''45'6_2819 v0 v3
du_'9839''45'6_2819 ::
  MAlonzo.Code.Agda.Primitive.T_Level_18 ->
  MAlonzo.RTE.Infinity
    AgdaAny
